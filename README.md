...
Este notebook é uma aplicação prática de uma rede neural _feedforward_ para tarefa de classificação binária de câncer de mama. Utilizando o _dataset Breast Cancer_, que contém diversas características de tumores mamários, o modelo é treinado para distinguir entre tumores benignos e malignos.
...
*   **⭕ ReLU** e **Sigmoid** foram algoritmos utilizados como funções de ativação.
